...
<body class="bg-white text-gray-800 font-sans">
    ...
    <header class="bg-white shadow-md sticky top-0 z-50">
        <div class="max-w-7xl mx-auto flex justify-between items-center py-4 px-6">
            <h1>
                <img src="{{ asset('storage/image/landing/logoLp3i.jpg') }}" 
                    alt="LP3I Logo" 
    ...
    <section id="beranda" class="bg-gray-50 py-16">
        <div class="max-w-7xl mx-auto px-6 flex flex-col-reverse md:flex-row items-center gap-8">
            ...
            <div class="md:w-1/2 flex justify-center">
                <img src="{{ asset('storage/image/landing/mahasiswa-lp3i.png') }}" alt="Mahasiswa LP3I" class="w-full max-w-2xl object-cover object-cover rounded-xl shadow-lg" />
            </div>
        </div>
    </section>
