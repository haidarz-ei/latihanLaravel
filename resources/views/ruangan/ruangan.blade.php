            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('ruangan.store') }}" class="space-y-4">
                        @csrf
                        <input type="text" name="namaRuangan" placeholder="Nama Ruangan" class="border-gray-300 rounded-md w-full" required>
                        <input type="number" name="kapasitas" placeholder="Kapasitas" class="border-gray-300 rounded-md w-full" required>
                    ...
                    <table class="table-auto w-full border">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border px-4 py-2">{{ $ruangan->namaRuangan }}</td>
