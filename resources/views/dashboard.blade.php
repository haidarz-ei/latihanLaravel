...
{{-- 
================================================================================
LAPORAN PERKEMBANGAN DASHBOARD
================================================================================
Tanggal: 2025-01-XX
Developer: AI Assistant

DESKRIPSI:
Dashboard admin dan user untuk sistem manajemen LP3I dengan fitur statistik,
visualisasi data, dan quick actions.

FITUR YANG DITAMBAHKAN:
1. Admin Dashboard:
   - Statistik Cards (4 cards): Total Mahasiswa, eKYC Pending, Total Dosen, Program Aktif
   - Chart Trend eKYC: Bar chart 6 bulan terakhir dengan hover effect
   - Progress Indicator: Verification rate dengan progress bar dan statistik
   - Status eKYC Overview: Breakdown status (Draft, Menunggu, Diterima, Ditolak)
   - Quick Actions: Link cepat ke Verifikasi eKYC, Kelola Mahasiswa, Landing Page
   - Recent eKYC Pending: Tabel 5 eKYC terbaru yang perlu verifikasi

2. User Dashboard:
   - Informasi personal untuk user yang eKYC-nya sudah accepted
   - Status eKYC dengan pesan selamat datang
   - Informasi eKYC yang sudah diterima

PERBAIKAN:
- Responsive design dengan grid system
- Color coding untuk setiap card dengan border accent
...
- Alpine.js untuk interaktivitas (jika diperlukan)
- Chart sederhana dengan CSS (bisa upgrade ke Chart.js jika diperlukan)

CATATAN:
- Dashboard otomatis mendeteksi role user (admin/user)
- Data statistik diambil dari controller DashboardController
- Chart trend menggunakan CSS murni, bisa ditingkatkan dengan library chart
- Verification rate dihitung dari accepted / total submitted
