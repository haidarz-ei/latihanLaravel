<x-app-layout>
    <div class="max-w-2xl mx-auto mt-12 bg-white p-6 rounded-lg shadow-lg">
        <h2 class="text-xl font-semibold text-center mb-6">eKYC - Step 1: Personal Information</h2>
        ...
        <form action="{{ route('ekyc.storeStep1') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea name="alamat" rows="3" class="w-full border-gray-300 rounded-md p-2 focus:ring focus:ring-blue-200" required>
                    {{ old('alamat', $ekyc->alamat ?? '') }}
                </textarea>
            </div>
